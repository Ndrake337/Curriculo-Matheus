...
\begin{resume_section}{Skills}
  ...
  \textbf{Back-End}  \= Javacript/Typescript; Node.JS; Express; Fastify;  Java; Spring Framework/Spring Boot; C/C++; Git/GitHub; \\* \>    \\*
  \textbf{Data Science} \= SQL; SQL Server; Hadoop; Python; Pandas; Matplotlib; Seaborn; Alteryx; Tableau;\\*
  \textbf{Front-End}  \> HTML; CSS; React/Next.js; TailwindCSS; \\* 
  \textbf{Mobile} \> React Native; \\*
  \textbf{Soft Skills}  \> Metodologia ágil; Comunicação; Clean Code; Solid\\*
